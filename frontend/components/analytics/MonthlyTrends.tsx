          ...
          <div key={trend.month} className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-4 text-sm">
                <span className="text-[#74d3ae]">Income: {formatCurrency(trend.income)}</span>
                <span className="text-[#dd9787]">Expense: {formatCurrency(trend.expense)}</span>
                <span className="text-[#a78bfa]">Investment: {formatCurrency(trend.investment)}</span>
              </div>
            </div>
            
            <div className="space-y-1">
              <div className="flex items-center gap-2">
                <div className="w-16 text-white/40 text-xs">Income</div>
              ...
              <div className="flex items-center gap-2">
                <div className="w-16 text-white/40 text-xs">Expense</div>
                <div className="flex-1 bg-white/10 rounded-full h-2">
                  <div
                    className="bg-[#dd9787] h-2 rounded-full transition-all"
              ...
              <div className="flex items-center gap-2">
                <div className="w-16 text-white/40 text-xs">Invest</div>
                <div className="flex-1 bg-white/10 rounded-full h-2">
                  <div
                    className="bg-[#a78bfa] h-2 rounded-full transition-all"
                    style={{ width: `${(trend.investment / maxValue) * 100}%` }}
                  />
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between pt-1">
              <span className="text-white/40 text-sm">Net</span>
              <span className={`text-sm font-medium ${trend.net >= 0 ? 'text-[#74d3ae]' : 'text-[#dd9787]'}`}>
